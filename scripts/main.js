...
function displayCardsDynamically(collection) {
    ...
    db.collection(collection)
        ...
        // .limit(1) // to limit # of hikes to display just 1 
        .then(allHikes => {
            ...
            allHikes.forEach(doc => { //iterate thru each doc
                ...
                document.getElementById(collection + "-go-here").appendChild(newcard); //when we send it off to the screen
...
//this function will update the bookmark
...
function updateBookmark(hikeDocID) {
    // alert("inside update bookmark"); //for debug 
    currentUser.get().then(doc => {
        console.log(doc.data().bookmarks); //for debug
        ...
        if (currentBookmarks && currentBookmarks.includes(hikeDocID)) {
            ...
            .then(function() {
                ...
                let iconID = "save-" + hikeDocID; //"save-2974523"
                console.log(iconID); 
                document.getElementById(iconID).innerText = "bookmark_boreder";
            })
        } else {
            currentUser.set({
